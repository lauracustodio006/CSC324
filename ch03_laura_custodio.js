...
// Recursion
/*
We’ve seen that we can use % (the remainder operator) to test whether a number is even or odd by using % 2 to see whether it’s divisible 
by two. Here’s another way to define whether a positive whole number is even or odd:
...
found at position string.length - 1. In other words, a two-character string has length 2, and 
